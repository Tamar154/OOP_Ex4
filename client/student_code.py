...
pikachu = pygame.image.load("../resources/pikachu.png")
snorlax = pygame.image.load("../resources/snorlax.png")
icon = pygame.image.load("../resources/pokeball.png")
Exit = pygame.image.load("../resources/exit.png").convert_alpha()
Pause = pygame.image.load("../resources/pause.png").convert_alpha()
...
bp = pygame.image.load("../resources/b3.jpg").convert()
picked_agent = 0
